...
<template>
  <div class="container narrow">
    ...
    <form v-else class="card form" @submit.prevent="save">
      ...
      <div class="actions">
        <span v-if="ok" class="saved">✓ Сохранено</span>
    ...
    <form v-if="!loading" class="card form pwd-card" @submit.prevent="changePassword">
      ...
      <div class="actions">
        <span v-if="pwdOk" class="saved">✓ Пароль обновлён</span>
...
.avatar {
  ...
  box-shadow: 0 12px 28px -10px rgba(3, 129, 254, 0.45);
}
...
.saved { color: var(--success); font-weight: 600; font-size: 14px; }
